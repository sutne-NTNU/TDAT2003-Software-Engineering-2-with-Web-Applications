...
class Services {
  ...
  validateUsername(username) {
    return axios
      .get(url + "/validate/username/" + username)
      .then((response) => response.data);
  }

  validateEmail(email) {
    return axios
      .get(url + "/validate/email/" + email)
      .then((response) => response.data);
  }
  ...
  updateUser(user) {
    return axios
      .put(url + "/auth/users/" + user.userId, user, {
        headers: { "x-access-token": authService.getToken() },
      })
      .then((response) => response.data);
  }
  ...
  updateEvent(event) {
    return axios
      .put(url + "/auth/events/" + event.eventId, event, {
        headers: { "x-access-token": authService.getToken() },
      })
      .then((response) => response.data);
  }
  ...
  deleteEvent(eventId) {
    return axios
      .delete(url + "/auth/events/" + eventId, {
        headers: { "x-access-token": authService.getToken() },
      })
      .then((response) => response.data);
  }
  ...
  searchForEvents(input) {
    return axios
      .get(url + "/events/search/" + encodeURIComponent(input))
      .then((response) => response.data);
  }

  getEventByEventId(eventId) {
    return axios
      .get(url + "/events/eventDetails/" + eventId)
      .then((response) => response.data);
  }

  getEventsByOrganizer(userId) {
    return axios
      .get(url + "/auth/events/users/" + userId, {
        headers: { "x-access-token": authService.getToken() },
      })
      .then((response) => response.data);
  }
  ...
  addPersonnel(personnel) {
    return axios
      .post(
        url + "/auth/events/" + personnel[0].eventId + "/personnel",
        personnel,
        { headers: { "x-access-token": authService.getToken() } }
      )
      .then((response) => response.data);
  ...
  deletePersonnel(eventId, personnelId) {
    return axios
      .delete(url + "/auth/events/" + eventId + "/personnel/" + personnelId, {
        headers: { "x-access-token": authService.getToken() },
      })
      .then((response) => response.data);
  }
  ...
  getPersonnel(eventId) {
    return axios
      .get(url + "/auth/events/" + eventId + "/personnel", {
        headers: { "x-access-token": authService.getToken() },
      })
      .then((response) => response.data);
  }
  ...
  addTickets(tickets) {
    return axios
      .post(url + "/auth/events/" + tickets[0].eventId + "/tickets", tickets, {
        headers: { "x-access-token": authService.getToken() },
      })
      .then((response) => response.data);
  }
  ...
  updateTicket(tickets) {
    return axios
      .put(url + "/auth/events/" + tickets[0].eventId + "/tickets", tickets, {
        headers: { "x-access-token": authService.getToken() },
      })
      .then((response) => response.data);
  }
  ...
  deleteTicket(ticket) {
    return axios
      .delete(
        url + "/auth/events/" + ticket.eventId + "/tickets/" + ticket.type,
        { headers: { "x-access-token": authService.getToken() } }
      )
      .then((response) => response.data);
  }
  ...
  getTicketToEvent(eventId) {
    return axios
      .get(url + "/events/" + eventId + "/tickets")
      .then((response) => response.data);
  }
  ...
  addGig(gig) {
    return axios
      .post(url + "/auth/events/" + gig.eventId + "/gigs", gig, {
        headers: { "x-access-token": authService.getToken() },
      })
      .then((response) => response.data);
  }
  ...
  deleteGig(gig) {
    return axios
      .delete(url + "/auth/events/" + gig.eventId + "/gigs/" + gig.artistId, {
        headers: { "x-access-token": authService.getToken() },
      })
      .then((response) => response.data);
  }
  ...
  getGigs(eventId) {
    return axios
      .get(url + "/auth/events/" + eventId + "/gigs", {
        headers: { "x-access-token": authService.getToken() },
      })
      .then((response) => response.data);
  }
  ...
  downloadContract(eventId, artistId) {
    return axios
      .get(url + "/auth/events/" + eventId + "/gigs/" + artistId, {
        headers: { "x-access-token": authService.getToken() },
      })
      .then((response) => response.data);
  }
  ...
  addRiderItems(riderItems) {
    return axios
      .post(
        url +
          "/auth/events/" +
          riderItems[0].eventId +
          "/gigs/" +
          riderItems[0].artistId +
          "/rider",
        riderItems,
        { headers: { "x-access-token": authService.getToken() } }
      )
  ...
  getRiderItems(eventId, artistId) {
    return axios
      .get(url + "/auth/events/" + eventId + "/gigs/" + artistId + "/rider", {
        headers: { "x-access-token": authService.getToken() },
      })
      .then((response) => response.data);
  }
  ...
  sendBug(mail) {
    return axios
      .post(url + "/mail/bug", mail)
      .then((response) => response.data);
  }

  sendMails(mail) {
    return axios
      .post(url + "/mail/info", mail)
      .then((response) => response.data);
  }
