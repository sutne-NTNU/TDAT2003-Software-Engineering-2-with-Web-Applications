...
class ArticleService {
  ...
  postComment(comment: Comment) {
    return axios
      .post<Comment, void>('/articles/' + comment.article_id + '/comments', comment)
      .then((response) => response.data);
  }

  likeComment(comment: Comment) {
    return axios
      .put<Comment, void>('/articles/' + comment.article_id + '/comments/' + comment.id, comment)
      .then((response) => response.data);
  }

  deleteComment(comment: Comment) {
    return axios
      .delete<Comment, void>('/articles/' + comment.article_id + '/comments/' + comment.id)
      .then((response) => response.data);
  }
}
