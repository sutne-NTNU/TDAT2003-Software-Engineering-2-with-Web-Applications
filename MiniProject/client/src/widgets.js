...
class ButtonLike extends Component<{
  ...
  render() {
    ...
    return (
      <button type="button" className="button-like" onClick={this.props.onClick}>
        <span className="glyphicon glyphicon-heart" aria-hidden="true" aria-label="Like" />
        {text + this.props.nr}
      </button>
    );
  }
...
class ButtonDelete extends Component<{
  ...
  render() {
    return (
      <button type="button" className="button-delete" onClick={this.props.onClick}>
        <span className="glyphicon glyphicon-trash" aria-hidden="true" aria-label="Delete" />
      </button>
    );
  }
}
...
class ButtonEdit extends Component<{
  ...
  render() {
    return (
      <button type="button" className="button-edit" onClick={this.props.onClick}>
        <span className="glyphicon glyphicon-edit" aria-hidden="true" aria-label="Delete" /> Edit
      </button>
    );
  }
}
...
class ButtonSave extends Component<{
  ...
  render() {
    return (
      <button type="button" className="button-edit" onClick={this.props.onClick}>
        <span className="glyphicon glyphicon-floppy-disk" aria-hidden="true" aria-label="Delete" /> Save
      </button>
    );
  }
}
...
class ButtonSend extends Component<{
  ...
  render() {
    return (
      <button type="button" className="button-edit" onClick={this.props.onClick}>
        <span className="glyphicon glyphicon-send" aria-hidden="true" aria-label="Send" /> {this.props.children}
      </button>
    );
  }
}
      ...
      <div className="input">
        <div className="input-image">
          ...
          <div className="input-image-preview">
            <img src={this.props.field} alt={'Invalid URL'} />
          </div>
        </div>
      </div>
    );
  ...
  render() {
    return (
      <div className="empty_result">
        ...
        <img src="https://i.imgur.com/s6b2jKz.png" alt="Sorry" />
      </div>
    );
  }
}
...
export class LivefeedArticle extends Component<{ article_id: number, title: string, createdAt: string }> {
  render() {
    return (
      <a className="livefeed-article" href={'/#/articles/' + this.props.article_id}>
        <div className="livefeed-container">
          <div className="livefeed-article-title">{this.props.title}</div>
          <div className="livefeed-article-time">{this.props.createdAt}</div>
        </div>
      </a>
    );
  }
...
export class FrontArticle extends Component<{
  article_id: number,
  title: string,
  createdAt?: string,
  image_link?: string,
  ...
  render() {
    return (
      <a className="article_front" href={'http://localhost:8888/#/articles/' + this.props.article_id}>
        <div className="content">
          {this.props.image_link ? <img src={this.props.image_link} alt={this.props.title} /> : null}
          <Row>
