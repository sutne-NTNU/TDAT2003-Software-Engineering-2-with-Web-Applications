...
test('add article', (done) => {
  function callback(status, data) {
    console.log(
      'Callback add article: status=' + status + ', insertID=' + data.insertId + ', affectedRows=' + data.affectedRows
    );
...
test('add comment', (done) => {
  function callback(status, data) {
    console.log(
      'Callback add comment: status=' + status + ', insertID=' + data.insertId + ', affectedRows=' + data.affectedRows
    );
    expect(data.affectedRows).toBe(1);
