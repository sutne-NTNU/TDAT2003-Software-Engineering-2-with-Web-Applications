			...
			]).then(() =>
				{
					ArticleModel.bulkCreate([
						...
						},
						{
							...
							content: 'Hei jeg kjøpte ved et uhell en ekstra bilett til filmen på lørdag, så om noen tilfeldigvis ønsker å være med en ensom student på kino kan du bare ta kontakt så skal jeg fikse alt og til og med kjøpe brus til deg',
						...
						},
						{
							...
							category_id: 3, //Sport
							content: 'Jeg og noen venner vil spille fotball, men vi mangler bane og ball og flere venner. Hadde vært kjempe koselig dersom noen kunne hjulpet oss :)',
						...
						},
						{
							...
							content: 'tok notater fra forelesningen dersom noen ikke kunne møte opp, var en ganske så nyttig forelesning!',
						...
						},
						{
							...
							content: 'Dette har reddet livet mitt såååå mange ganger, bare legg pizzaen på en strykejern og blås på den med sånn vifte ting, så får du varm pizza kjempefort',
