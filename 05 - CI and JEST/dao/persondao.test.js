...
test("get one person from db", (done) => {
  function callback(status, data) {
    console.log(
      "Callback, get one person: status=" +
        status +
        ", person=" +
        JSON.stringify(data)
    );
...
test("update one person in db", (done) => {
  function callback(status, data) {
    console.log(
      "Callback update one person: status=" +
        status +
        ", changedRows=" +
        data.changedRows
    );
  ...
  personDao.updateOne(
    1,
    { navn: "Sivert Utne", alder: 75, adresse: "India" },
    callback
  );
});
...
test("get unknown person from db", (done) => {
  function callback(status, data) {
    console.log(
      "Callback get unknown person: status=" +
        status +
        ", person=" +
        JSON.stringify(data)
    );
...
test("add person to db", (done) => {
  function callback(status, data) {
    console.log(
      "Callback add person to db: status=" +
        status +
        ", insertID=" +
        data.insertId +
        ", affectedRows=" +
...
test("get all persons from db", (done) => {
  function callback(status, data) {
    console.log(
      "Callback get all persons from db: status=" +
        status +
        ", data.length=" +
        data.length
    );
...
test("delete one person from db", (done) => {
  function callback(status, data) {
    console.log(
      "Callback sletter to personer: Status=" +
        status +
        ", affectedRows=" +
        data.affectedRows
    );
